...
internal sealed class AddChainPuzzleToSecurityDoor : BaseEvent
{
    ...
    protected override void TriggerCommon(WEE_EventData e)
    {
        ...
        var block = ChainedPuzzleDataBlock.GetBlock(e.ChainPuzzle);
        ...
        LogInfo($"Door into zone {door.Gate.m_linksTo.m_zone.m_navInfo.GetFormattedText(LG_NavInfoFormat.Full_And_Number)} was added ChainedPuzzle {e.ChainPuzzle}");
